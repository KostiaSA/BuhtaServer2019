...
namespace HandlebarsDotNet.Compiler.Lexer
{
    ...
    {
        //private const string validWordStartCharacters = "абвгжеёжзийклмнопрстуфхцчшщьыъэюяАБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЬЫЪЭЮЯabcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_$.@[]";
        private const string validWordStartCharacters = "_$.@[]";  // buhta
        ...
        private bool IsWord(TextReader reader)
        {
            ...
            return Char.IsLetter(peek) || validWordStartCharacters.Contains(peek.ToString());  // buhta
        }
